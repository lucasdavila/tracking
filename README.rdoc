...
This tracking system can track visits to your site's pages, and also receive contact messages. When a user send a contact the sistem will assign his visits to his email, this way you can see which pages that user already visited.
